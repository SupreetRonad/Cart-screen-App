...
import 'package:puthon/main.dart';
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: SizedBox(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text("Place Oder and pay Rs. " + total.toString() , style: TextStyle(fontWeight: FontWeight.bold )),
          ...
          children: [
            Row(
              children: [
                ...
                Text("  Shipment Details", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
              ],
            ),
            SizedBox(height: 10,),
            name == null ? Container(
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("  Please fill following details", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                    SizedBox(height: 10,),
                    Container(
